...
windows = Group(
    Line(125, 160, 125, 210, lineWidth=14, dashes=(15,2), fill='saddleBrown'),
    Line(140, 160, 140, 210, lineWidth=14, dashes=(15,2), fill='saddleBrown'),
    Line(193, 160, 193, 210, lineWidth=14, dashes=(15,2), fill='saddleBrown'),
    Line(208, 160, 208, 210, lineWidth=14, dashes=(15,2), fill='saddleBrown'),
    Line(260, 160, 260, 210, lineWidth=14, dashes=(15,2), fill='saddleBrown'),
    Line(275, 160, 275, 210, lineWidth=14, dashes=(15,2), fill='saddleBrown'),
    Line(125, 233, 125, 283, lineWidth=14, dashes=(15,2), fill='saddleBrown'),
    Line(140, 233, 140, 283, lineWidth=14, dashes=(15,2), fill='saddleBrown'),
    Line(260, 233, 260, 283, lineWidth=14, dashes=(15,2), fill='saddleBrown'),
    Line(275, 233, 275, 283, lineWidth=14, dashes=(15,2), fill='saddleBrown')
    )
door = Group(
