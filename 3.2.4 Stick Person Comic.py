...
### Modify Your Code Here ###
Label('I do not get your code', 300, 40, fill='black', font='monospace', size=12)
...
### Modify Your Code Here ###
Label('Neither do I', 100, 240, fill='black', font='monospace', size=12)
...
### Modify Your Code Here ###
Label('But it works!!', 300, 240, fill='black', font='monospace', size=12)
