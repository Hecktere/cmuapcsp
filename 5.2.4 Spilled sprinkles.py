...
Oval(380, 240, 30, 60, fill=gradient('indianRed','gold', start='left'),
...
sprinkles = Group(
    ...
    RegularPolygon(240, 320, 8, 4, fill='indianRed'),
    ...
    Star(380, 330, 10, 5, fill='indianRed'),
...
def onMousePress(mouseX, mouseY):
    ...
    for sprinkle in sprinkles.children:
        if(sprinkle == app.selected):
