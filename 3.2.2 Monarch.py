...
Polygon(180, 150, 125, 100, 120, 75, 145, 85, fill='orange')
Polygon(160, 165, 100, 140, 70, 100, 125, 115, fill='orange')
Polygon(140, 180, 90, 185, 70, 155, 105, 155, fill='orange')
# ottom half of the pattern
